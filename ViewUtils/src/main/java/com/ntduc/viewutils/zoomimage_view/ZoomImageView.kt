...
import com.ntduc.viewutils.R

// https://github.com/jsibbold/zoomage/tree/master

class ZoomImageView : AppCompatImageView, OnScaleGestureListener {
     ...
     */
    var doubleTapToZoom: Boolean = false
    /**
     ...
     */
    var restrictBounds: Boolean = false
    /**
     ...
     */
    var animateOnReset: Boolean = false
    /**
     ...
     */
    var currentScaleFactor: Float = 1f
        private set
    ...
    private val currentDisplayedWidth: Float
         ...
         */
        get() = if (drawable != null) drawable.intrinsicWidth * matrixValues[Matrix.MSCALE_X]
        else 0f
    ...
    private val currentDisplayedHeight: Float
         ...
         */
        get() {
            return if (drawable != null) drawable.intrinsicHeight * matrixValues[Matrix.MSCALE_Y]
            else 0f
        }
    ...
    private fun animateScaleAndTranslationToMatrix(targetMatrix: Matrix, duration: Int) {
        ...
        resetAnimator?.addUpdateListener(object : ValueAnimator.AnimatorUpdateListener {
            val activeMatrix: Matrix = Matrix(imageMatrix)
